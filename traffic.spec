...
%changelog
* Sat Feb 01 2003 Robert Sandilands <rsandila@netscape.net>
- Added license text to all source files
* Wed Dec 04 2002 Robert Sandilands <rsandila@netscape.net>
- Fixed build issue if you do not have Kylix installed
